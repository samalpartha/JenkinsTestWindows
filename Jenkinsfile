node{
    ...
    stage 'Nuget Packages Restore'
        bat label: '', script:'''"C:\\Users\\Partha\\Documents\\nuget.exe restore "C:\\Program Files (x86)\\Jenkins\\workspace\\AzureReposDemo\\CalculatorTest.sln"'''
    stage 'Buiild MSBuild'
        ...
        cd %msbildpath%
        MSBuild.exe "C:\\Program Files (x86)\\Jenkins\\workspace\\AzureReposDemo\\CalculatorTest.sln"'''
		}
}
